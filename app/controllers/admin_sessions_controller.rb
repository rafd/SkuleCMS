  ...
  def create
    ...
    respond_to do |format|
      if @admin_session.save
        ...
        format.html { redirect_to(current_admin.super_admin ? admins_path : (current_admin.club_id.blank?)? new_club_path: club_admin_index_path(Club.find(current_admin.club_id))) }
