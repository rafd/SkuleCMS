module EventCalendar
  module CalendarHelper
        ...
        range.collect do |r|
          ...
          if !event.nil?
            ...
            if dates[0] - start_date == days_in_week
              ...
              start_d = event.start.to_date
              end_d = event.finish.nil? ? start_d+1 : event.finish.to_date+1
    ...
    def event_content(event, days, cur_offs, idx, event_width, event_height, event_margin, &block)
      cal = ""
      cal << "<div event_id='#{event.id}' day='#{event.start.day}' color='#{event.color}' "
